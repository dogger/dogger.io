            ...
            <Container style={{
                ...
                <Grid container spacing={0}>
                    ...
                    <Grid item xs={12} sm={6} md={4}>
                        <BenefitGridItem
                            title="Starts free"
                            description={<>There's a free-forever plan available, and our pricing scales are your project scales with it.</>}
                    ...
                    <Grid item xs={12} sm={6} md={4}>
                        <BenefitGridItem
                            ...
                            description={<>In addition to <a target="_blank" href="https://plausible.io/dogger.io" rel="noopener noreferrer">sharing our traffic</a> and <a rel="nofollow noopener noreferrer" target="_blank" href="https://github.com/dogger">source code</a>, we also expose our <a rel="nofollow noopener noreferrer" target="_blank" href="https://github.com/orgs/dogger/projects/1">roadmap</a> publically.</>}
